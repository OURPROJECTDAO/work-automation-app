...
**덮어쓰기:**
- 📉**매출목표 미달**(가장 잘 파는 채널도 월 100만 미만) → 더 팔리게 **나들 마진까지 절반 내림** 🟡 / 이미 쌈이면 🔴
...
*항상: 절반씩만 · 역마진 금지·**3% 절대 하한**(어떤 경우에도 3% 미만은 권장 안 함 — 미만이면 그냥 유지·작업목록서 제외) · 전부 사람 저장 · 측정 루프가 다음 사이클에 검증(악화→되돌림) · 선물세트·나들·미관리 채널 제외.*"""
